...
class DiffusionTransformer(nn.Module):
    ...
    def _train_loss(self, x, cond_emb, is_train=True, obj_mask=None):                       # get the KL loss
    ...
    def forward(
        ...
        if is_train == True:
            log_model_prob, loss = self._train_loss(sample_image, cond_emb, obj_mask=input.get('obj_mask', None))
